...
<div role="document" class="page <?php if ($footer_sticky == true) {print 'sticky-footer';
  ...
  <byu-header <?php if ($full_width == true) { print 'full-width'; 
    ...
    <?php if ($menu_use == true) : ?>
      ...
      <byu-menu slot="nav" collapsed id="main-menu" class="navigation <?php if ($transparent == true) { print 'transparent'; 
     } ?>" role="navigation">
        <?php
...
<?php endif; ?>
    ...
    <div id="page-container" <?php if ($footer_sticky == true) {print 'class="sticky-footer"';
   }?> <?php if (!empty($min_page_height)) { print 'style="min-height: ' . $min_page_height . 'px;"'; 
} ?>>
