...
;(function ($, window, document, undefined) {
    ...
    Foundation.libs.topbar = {
        ...
        events : function () {
            ...
            .off('.fndtn.topbar')
            .on(
                'click.fndtn.topbar', '.top-bar .toggle-topbar, [data-topbar] .toggle-topbar', function (e) {
                    e.preventDefault();
                    self.toggle();
                }
            )
            ...
            .on(
                'click.fndtn.topbar', '.top-bar li.has-dropdown', function (e) {
                    var li = $(this),
                    target = $(e.target),
            ...
            .on(
                'click.fndtn.topbar', '.top-bar .has-dropdown>a, [data-topbar] .has-dropdown>a', function (e) {
            ...
            $(this.scope).on(
                'click.fndtn', '.top-bar .has-dropdown .back, [data-topbar] .has-dropdown .back', function (e) {
                    e.preventDefault();
        ...
        assemble : function () {
            ...
            this.settings.$section.find('.has-dropdown>a').each(
                function () {
                    var $link = $(this),
