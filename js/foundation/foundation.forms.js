(function ($, window, document, undefined) {
    ...
    Foundation.libs.forms = {
        ...
        events: function () {
            ...
            $(this.scope)
            .on(
                'click.fndtn.forms', 'form.custom span.custom.checkbox', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
            ...
            .on(
                'click.fndtn.forms', 'form.custom span.custom.radio', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
            ...
            .on(
                'change.fndtn.forms', 'form.custom select', function (e, force_refresh) {
            ...
            .on(
                'click.fndtn.forms', 'form.custom label', function (e) {
            ...
            .on(
                'mousedown.fndtn.forms', 'form.custom div.custom.dropdown', function () {
                    return false;
                }
            )
            .on(
                'click.fndtn.forms', 'form.custom div.custom.dropdown a.current, form.custom div.custom.dropdown a.selector', function (e) {
                    var $this = $(this),
                    ...
                    if (false === $select.is(':disabled')) {
                        ...
                        if ($dropdown.hasClass('open')) {
                            $(self.scope).on(
                                'click.fndtn.forms.customdropdown', function () {
            ...
            .on(
                'click.fndtn.forms touchend.fndtn.forms', 'form.custom div.custom.dropdown li', function (e) {
                    var $this = $(this),
        ...
        append_custom_select: function (idx, sel) {
            ...
            if ($customSelect.length === 0) {
                ...
                $customSelect = $(
                    '<div class="' + ['custom', 'dropdown', customSelectSize].concat(copyClasses).filter(
