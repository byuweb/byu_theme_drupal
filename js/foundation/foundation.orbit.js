;(function ($, window, document, undefined) {
    ...
    var Orbit = function (el, settings) {
        ...
        self.build_markup = function () {
            ...
            if (settings.bullets) {
                ...
                slides_container.children().each(
                    function (idx, el) {
        ...
        self.init = function () {
            ...
            if (settings.swipe) {
                container.on(
                    'touchstart.fndtn.orbit', function (e) {
                ...
                .on(
                    'touchmove.fndtn.orbit', function (e) {
                        if (!e.touches) { e = e.originalEvent; }
                ...
                .on(
                    'touchend.fndtn.orbit', function (e) {
            ...
            container.on(
                'mouseenter.fndtn.orbit', function (e) {
            ...
            .on(
                'mouseleave.fndtn.orbit', function (e) {
    ...
    var SlideAnimation = function (settings, container) {
        ...
        this.next = function (current, next, callback) {
            next.animate(
                animMargin, duration, 'linear', function () {
    ...
    var FadeAnimation = function (settings, container) {
        ...
        this.next = function (current, next, callback) {
            ...
            next.animate(
                {'opacity':'1'}, duration, 'linear', function () {
                    current.css('margin', '100%');
                    callback();
                }
            );
