...
(function ($, window, document, undefined) {
    ...
    Foundation.libs.joyride = {
        ...
        events : function () {
            ...
            $(this.scope)
            .on(
                'click.joyride', '.joyride-next-tip, .joyride-modal-bg', function (e) {
                    e.preventDefault();
            ...
            .on(
                'click.joyride', '.joyride-close-tip', function (e) {
                    e.preventDefault();
                    this.end();
                }.bind(this)
            );
            ...
            $(window).on(
                'resize.fndtn.joyride', self.throttle(
                    function () {
        ...
        start : function () {
            ...
            if (!this.settings.cookieMonster || this.settings.cookieMonster && $.cookie(this.settings.cookieName) === null) {
                this.settings.$tip_content.each(
                    function (index) {
                        var $this = $(this);
