...
;(function ($, window, document, undefined) {
    ...
    Foundation.libs.reveal = {
        ...
        events : function () {
            ...
            .off('.fndtn.reveal')
            .on(
                'click.fndtn.reveal', '[data-reveal-id]', function (e) {
                    e.preventDefault();
            ...
            .on(
                'click.fndtn.reveal touchend', this.close_targets(), function (e) {
                    e.preventDefault();
                    if (!self.locked) {
        ...
        show : function (el, css) {
            ...
            if (css) {
                if (el.parent('body').length === 0) {
                    ...
                    el.on(
                        'closed.fndtn.reveal.wrapped', function () {
                ...
                if (/pop/i.test(this.settings.animation)) {
                    ...
                    return this.delay(
                        function () {
                            ...
                            .css(css)
                            .animate(
                                end_css, this.settings.animationSpeed, 'linear', function () {
                                    this.locked = false;
                                    el.trigger('opened');
                                }.bind(this)
                            )
